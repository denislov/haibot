...
import haibot.providers.provider_manager as provider_manager_module
...
from haibot.providers.provider import DefaultProvider, ModelInfo
from haibot.providers.provider_manager import ProviderManager
