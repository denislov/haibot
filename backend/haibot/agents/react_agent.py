...
HaiBotAgentFormatter = create_file_block_support_formatter(
    OpenAIChatFormatter,
)


class HaiBotInMemoryMemory(InMemoryMemory):
    """bugfix"""
...
class HaiBotAgent(ReActAgent):
    def __init__(
        ...
        model_type = llm_cfg.model_type if llm_cfg else "openai"
        if model_type == "anthropic":
            ...
            _formatter = AnthropicChatFormatter()
        else:
            ...
            _formatter = HaiBotAgentFormatter()
        ...
        self.register_instance_hook(
            ...
            hook=HaiBotAgent._pre_reasoning_bootstrap_hook,
        )
        ...
        if enable_memory_manager and self.memory_manager is not None:
            self.register_instance_hook(
                ...
                hook=HaiBotAgent._pre_reasoning_compact_hook,
            )
