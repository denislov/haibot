...
MINIMAX_CODINGPLAN_MODELS: List[ModelInfo] = [
    ModelInfo(id="MiniMax-M2.5", name="MiniMax M2.5"),
...
PROVIDER_MINIMAX_CODINGPLAN = ProviderDefinition(
    id="minimax-codingplan",
    name="MiniMax Coding Plan",
    default_base_url="https://api.minimaxi.com/anthropic",
    api_key_prefix="sk-cp",
    models=MINIMAX_CODINGPLAN_MODELS,
...
PROVIDERS: dict[str, ProviderDefinition] = {
    ...
    PROVIDER_MINIMAX_CODINGPLAN.id: PROVIDER_MINIMAX_CODINGPLAN,
