...
# "openai"    – uses OpenAIChatModel (OpenAI-compatible REST API)
# "anthropic" – uses AnthropicChatModel (Anthropic SDK)
...
class ProviderDefinition(BaseModel):
    ...
    model_type: ModelType = Field(
        default="openai",
        description="Which model backend class to use (openai / anthropic)",
    )
...
class ProviderInfo(BaseModel):
    ...
    model_type: ModelType = Field(default="openai")
...
class ResolvedModelConfig(BaseModel):
    ...
    model_type: ModelType = Field(
        default="openai",
        description="Which model backend class to use",
    )
