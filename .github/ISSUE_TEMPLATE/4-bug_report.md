...
[Provide the version of HaiBot you are using, e.g. 0.x.x or git commit hash.]
[Using `haibot --version` in your command line or checking the version in the console UI can help.]
...
- **HaiBot version:** [e.g. 0.x.x or git commit]
