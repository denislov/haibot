...
@click.group(
    ...
    lazy_subcommands={
        "app": ("haibot.cli.app_cmd", "app_cmd", ".app_cmd"),
        "channels": (
            "haibot.cli.channels_cmd",
            "channels_group",
            ".channels_cmd",
        ),
        "channel": (
        ...
        "daemon": ("haibot.cli.daemon_cmd", "daemon_group", ".daemon_cmd"),
        "chats": ("haibot.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "chat": ("haibot.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "clean": ("haibot.cli.clean_cmd", "clean_cmd", ".clean_cmd"),
        "cron": ("haibot.cli.cron_cmd", "cron_group", ".cron_cmd"),
        "env": ("haibot.cli.env_cmd", "env_group", ".env_cmd"),
        "init": ("haibot.cli.init_cmd", "init_cmd", ".init_cmd"),
        "models": (
            "haibot.cli.providers_cmd",
            "models_group",
            ".providers_cmd",
        ),
        "skills": ("haibot.cli.skills_cmd", "skills_group", ".skills_cmd"),
        "uninstall": (
            "haibot.cli.uninstall_cmd",
            "uninstall_cmd",
            ".uninstall_cmd",
        ),
        "desktop": ("haibot.cli.desktop_cmd", "desktop_cmd", ".desktop_cmd"),
        "update": ("haibot.cli.update_cmd", "update_cmd", ".update_cmd"),
        "shutdown": (
            "haibot.cli.shutdown_cmd",
            "shutdown_cmd",
            ".shutdown_cmd",
        ),
        "auth": ("haibot.cli.auth_cmd", "auth_group", ".auth_cmd"),
        "agents": ("haibot.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "agent": ("haibot.cli.agents_cmd", "agents_group", ".agents_cmd"),
    },
)
