# -*- coding: utf-8 -*-
"""CLI command: run HaiBot app on a free port in a native webview window."""
...
def desktop_cmd(
    ...
    """Run HaiBot app on an auto-selected free port in a webview window.
    ...
    window without conflicting with an existing HaiBot app instance.
    """
    ...
    click.echo(f"Starting HaiBot app on {url} (port {port})")
